...
<div class="navbar" :class="{searching:ui.searching}">
  ...
  <template v-else>
    ...
    <div class="center">
	      <button v-if="pickable && !segments.length" id="picker-trigger" class="pickttl pointer"
  ...
  computed: {
    themeTitle: function () {
      return this.ui.theme === 'light' ? 'Dark theme' : 'Light theme';
    }
  },
  methods: {
